...
data modify block 29999984 0 0 front_text.messages[0] set value '[{"score":{"objective": "loy.value","name": "#temp.0"},"color":"white","italic": false},{"text":"x","color":"white","italic": false},{"score":{"objective": "loy.value","name": "#temp.1"},"color":"white","italic": false}]'
data modify storage paint:main CanvasLore append from block 29999984 0 0 front_text.messages[0]
