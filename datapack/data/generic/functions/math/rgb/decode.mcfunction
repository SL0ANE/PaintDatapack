scoreboard players operation #math.output.2 loy.value = #math.input.0 loy.value
scoreboard players operation #math.output.2 loy.value %= #256 loy.value
...
scoreboard players operation #math.output.1 loy.value /= #256 loy.value
